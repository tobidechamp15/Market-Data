  ...
  <div className={`flex md:h-screen      ${addClass ? 'hidden' : ''}`}>
    <section className="home-container flex flex-col  w-full p-[5%] justify-end md:h-screen md:justify-center  bg-orange-100 rounded-bl-[60px]">
      ...
      <p className=' mt-[10%] font-semibold text-[18px] text-justify w-[70%] font-["Poppins", sans-serif] '>
        Make smart decisions with our food data. Tap into our real-time, daily,
        and historical food market data pipeline.
      </p>
      <button type="button" className="px-5 py-5 lg:px-12 lg:py-4  mt-16 rounded  bg-black w-fit text-base text-white">
        Get Started
      </button>
    </section>
